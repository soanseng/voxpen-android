...
class TranscriptionRepositoryTest {
    ...
    @Test
    fun `should insert transcription and return id`() = runTest {
    ...
    @Test
    fun `should return all transcriptions as flow`() = runTest {
        val entities = listOf(
            TranscriptionEntity(id = 1, fileName = "a.wav", originalText = "A", language = "en", createdAt = 2000L),
            TranscriptionEntity(id = 2, fileName = "b.wav", originalText = "B", language = "zh", createdAt = 1000L),
        )
    ...
    @Test
    fun `should get transcription by id`() = runTest {
        val entity = TranscriptionEntity(id = 1, fileName = "a.wav", originalText = "A", language = "en", createdAt = 1000L)
    ...
    @Test
    fun `should update transcription`() = runTest {
        val entity = TranscriptionEntity(id = 1, fileName = "a.wav", originalText = "A", refinedText = "Polished A", language = "en", createdAt = 1000L)
