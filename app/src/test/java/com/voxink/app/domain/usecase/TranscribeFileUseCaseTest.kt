...
class TranscribeFileUseCaseTest {
    ...
    @Test
    fun `should transcribe small WAV file in single chunk`() = runTest {
    ...
    @Test
    fun `should merge results from multiple chunks`() = runTest {
    ...
    @Test
    fun `should save transcription to repository`() = runTest {
    ...
    @Test
    fun `should return failure when transcription fails`() = runTest {
        val pcmData = ByteArray(100) { (it % 256).toByte() }
        val wavBytes = AudioEncoder.pcmToWav(pcmData, 16000, 1, 16)
    ...
    @Test
    fun `should handle non-WAV files as raw chunks`() = runTest {
    ...
    @Test
    fun `should include file size in saved entity`() = runTest {
